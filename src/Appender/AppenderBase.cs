...
{
	/// <summary>
	/// Base class for Appender skeletons such as <see cref="AppenderSkeleton"/>.
	/// </summary>
	/// <remarks>
	/// <para>
	/// This class provides the code for common functionality, such 
	/// as support for threshold filtering, support for general filters and
	/// an <see cref="IErrorHandler"/>.
	/// </para>
	/// <para>
	/// It was extracted into a base class from <see cref="AppenderSkeleton"/>, principally
	/// to make it available for other <see cref="IAppender"/> implementations such as
	/// <see cref="AsyncAppenderSkeleton"/>.
	/// </para>
	/// </remarks>
	...
	public abstract class AppenderBase : IFlushable
	{
		...
		/// <summary>
		/// Test if the logging event should be output by this appender
		/// </summary>
		...
		/// log message.
		/// </remarks>
		private readonly static Type declaringType = typeof(AppenderBase);
